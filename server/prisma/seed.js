...
async function seed() {
  ...
  const kyle = await prisma.user.create({ data: { name: "Kyle", email: "kyle@user.com" } })
  const sally = await prisma.user.create({ data: { name: "Sally", email: "sally@user.com" } })
  ...
  const post2 = await prisma.post.create({
    data: {
      ...
      title: "Proin ut sollicitudin lacus",
    },
  })
